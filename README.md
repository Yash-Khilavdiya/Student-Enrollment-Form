...
2. Multi mode database - It supports variety of database functionality in one Solution such as MySQL, NoSQL, TimeSeries Based, Spatial Database etc.
3. Serverless Support make it easy for developers to use and manage.
4. Multiple Security Layers for better security of data.
5. Fast database since built around World fastest indexing engine - **PowerIndex**
6. Inbuilt support for querying multiple databases.

# Release History (release of your JsonPowerDB related code on Github)
> First version - currently uploaded project which meets the initial requirement is built as uploaded on the github.
# Table of contents
# Illustrations
* **Initial Page**
...
1. Creating a student record - Firstly we can create a new student record and save the student details in the jsonpowerdb database.
2. Updatign a student record - We can update the existing student reocrd in the database using the roll no. of the student from the frontend side from the form using the get and update api's and command of jsonPowerDb database.
# Examples of use
- For storing, fetching and updating student recored.
- Code in index.html and index.js file and libraries used as specified in sources.
- As shows in [Illustrations](#illustrations)
# Project status
**Completed initial version** of the project and now can be further extended.
# Sources
- HTML, CSS, Javascript
- Bootstrap
- JQuery
- [**jsonPowerDb Database**](http://api.login2explore.com:5577/user/jpdb_view.html)
- [**jpdb-common.js library**] - (https://login2explore.com/jpdb/resources/js/0.0.3/jpdb-commons.js)
- NetBeans IDE 
